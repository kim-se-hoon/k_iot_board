...
public class ApiMappingPattern {
    ...
    public static final class Users {
        ...
        public static final class Boards {
            ...
            public static final String ROOT = BASE + "/bards";
            ...
            public static final String DRAFT_BY_ID = ROOT + "/{draftId}";
